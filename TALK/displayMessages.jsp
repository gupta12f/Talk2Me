...
<HEAD>
 <link rel="shortcut icon" href="favicon.ico">
    ...
    <style>
        html {
        background: url(nothing.png) no-repeat center center fixed;
...
<%
    ...
    if(messages != null && messages.length > 0)
    {
        for (int i = 0; i < messages.length; i++)
        {
            ...
            {
                out.write("<font face=\"Arial\" size=\"2\" color=\"blue\"><b>" + chatterName + " ("+ DateFormat.getTimeInstance().format(date)+ ")&gt;</b></font> <font face=\"Press Start 2P\" size=\"2\" color=#009966>" +  strmsg+"</font><br>\n");
            }
            ...
            {
                out.write("<font face=\"Arial\" color=\"red\" size=\"2\"><b>"+chatterName + " ("+ DateFormat.getTimeInstance().format(date)+ ")&gt;</b></font> <font face=\"Press Start 2P\" size=\"2\" color=\"#58d244\">" + strmsg + "</font><br>\n");
            }
        }
