    ...
    <TR>
        ...
        <TD width="50%">
            <TABLE border="1" cellpadding="3" cellspacing="0" class="panel">
                ...
                <TR align="left" valign="top">
				    <FORM name="deleteinfo" action="deleteind.jsp" method="post" target="_top">
                        <TD width="10%">
                ...
                <TR align="left" valign="top">
					<FORM name="viewinfo">
                        <TD width="10%">
                            <INPUT type="Button" value="View Profile" onClick='winopen("viewind.jsp")'>
                        </TD>
                    </FORM>
					<FORM name="editinfo1">
                        <TD width="10%">
                            <INPUT type="Button" value="Change Details" onClick='winopen("editind.jsp")'>
                        </TD>
                    </FORM>
					<FORM name="propic" >
                        <TD width="10%">
                            <INPUT type="Button" value="Upload Pic" onClick='winopen("propic.jsp")'>
                        </TD>
                    </FORM>
