...
public class Chatter
{
	...
	* It accepts a name age and time of his login.
	* parameter name name of the chatter
	* parameter age age of the chatter
	* parameter loginTime time when user logged in. Got using Date.getTime(). Works as a timestamp.
	*/
	...
	* parameter comment Comment made by the chatter
	* return void
	*/
	...
	* parameter long milliseconds got using Date.getTime()
	*/
